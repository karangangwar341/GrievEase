...
const GovernmentWater = () => {
  ...
  return (
    <div>
      <div className="card-headerG text-3xl font-bold text-orange-900 mb-4 items-center justify-center' text-center">Grievances Pending at Water DepartMent</div>
...
export default GovernmentWater;
