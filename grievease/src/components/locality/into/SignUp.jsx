  ...
  return (
    <div className="flex items-center justify-center">
      <form onSubmit={submitHandler} className="bg-white/20 bg-opacity-75 backdrop-blur-lg p-4 rounded-xl shadow-lg w-96">
        <h2 className="text-center text-orange-900 text-3xl font-medium mb-4">Signup</h2>
        ...
        <div className="mt-2 rounded-xl">
            <label htmlFor="Locality" className="text-orange-900 font-medium text-sm">Locality</label>
            <input id="Locality" type="text" name="Locality" required className="bg-white/30 bg-opacity-75 border-b border-white text-orange-900 font-medium w-full py-1 px-2 mt-1 focus:outline-none focus:border-orange-500 text-sm rounded-md mb-2 focus:shadow-lg focus:shadow-white/50 h-8" />
          </div>
          <div className="mt-2 rounded-xl">
            <label htmlFor="City" className="text-orange-900 font-medium text-sm">City</label>
            <input id="City" type="text" name="City" required className="bg-white/30 bg-opacity-75 border-b border-white text-orange-900 font-medium w-full py-1 px-2 mt-1 focus:outline-none focus:border-orange-500 text-sm rounded-md mb-2 focus:shadow-lg focus:shadow-white/50 h-8" />
          </div>
